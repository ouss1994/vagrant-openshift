...
Vagrant.configure("2") do |config|
  ...
  #config.ssh.private_key_path = ["key/.ssh/vagrant_rsa", "~/.vagrant.d/insecure_private_key"]
  #config.vm.provision "file", source: "key/.ssh/vagrant_rsa.pub", destination: "~/.ssh/authorized_keys"
